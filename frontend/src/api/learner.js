...
/**
 * Fetch all historical and active user learning paths.
 * GET /api/learning-paths/history
 * @returns {Promise<Array<{ title: string, description: string, estimated_hours: number, skills: any[], nodes: any[], milestones: any[] }>>}
 */
export function fetchLearningPathsHistory() {
  return api.get('/api/learning-paths/history');
}
