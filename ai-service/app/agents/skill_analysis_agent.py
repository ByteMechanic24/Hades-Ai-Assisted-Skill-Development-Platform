...
class LearnerSkillAnalysisAgent:
    ...
    def analyze_learner(
        ...
        if isinstance(agent_response.content, GoalSkillReasoning):
            ...
            clean_str = agent_response.content.strip()
            ...
            try:
                ...
                reasoning = GoalSkillReasoning.model_validate(parsed_json)
            except Exception:
                reasoning = GoalSkillReasoning(
                    required_skills=[
                        f"Foundations of {effective_goal}",
                    ...
                    reasoning_summary=f"Synthesized comprehensive prerequisite sequence for {effective_goal}."
                )
        else:
